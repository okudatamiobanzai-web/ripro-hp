...
window.RIPRO_ITEMS = [
  ...
  },
  {
    ...
    "name": "家電製品",
    "category": "家電製品",
    "price": "リサイクル料金＋手数料 1台 3,300円〜",
    "free": false,
    "commonDesc": "リサイクル券はリプロでご用意します。料金は、家電リサイクル券センターのリサイクル料金（品目ごとに異なります）に、リプロの手数料（振込手数料・収集運搬料）として1台目 3,300円／2台目以降 1台 1,100円を加えた金額です。詳しくはお問い合わせください。",
    "subitems": [
      {
        "image": "assets/placeholder.svg",
        "label": "洗濯機",
